    ...
    function Vy_(_, __) {
        if (1 == __ || 3 == __ || 0 == __ || 23 == __ || 49 == __ || 7 == __ || 36 == __ || 35 == __) {
            ...
            var ___ = function(_, __) {
                ...
                if (1 == _ && (___ = _y_(U__, y__)),
                3 == _ && (___ = v_U(U__)),
                0 == _ && (___ = null),
                23 == _ && (___ = v_U(U__)),
                49 == _ && (___ = _v_(__v(U__, y__))),
                7 == _ && (___ = !!_V_(V__(_y_(U__, y__)))),
                36 == _ && (___ = _U_(__v(U__, y__))),
                35 == _) {
                    var __y = __v(U__, y__)
                            ...
                            if (45 == __U) {
                                ...
                                function V_V(_, ___, v__, V__, y__) {
                                    ___[v__].map(function(___) {
                                        Vv_(___, v__) ? V_V(_, ___, v__, V__, y__) : Vv_(___, 3) && (V_v ? (V_v = !1,
                                        y__ ? _u_(_)[0][__(___, 3)] = V__ : _V_(_, __(___, 3), V__)) : y__ ? _u_(_)[0][__(___, 3)] = void 0 : _V_(_, __(___, 3), void 0))
                                    })
                                }
                                ...
                                for (var _v in V_u)
                                    ...
                                    ___(_U[29]))
                                        ...
                                        if (Vv_(u_[0], 3) ? _V_(_, __(u_[0], 3), _v) : Vv_(u_[0], 21) ? (V_V(_, u_[0], 21, _v),
                                        V_v = !0) : Vv_(u_[0], 28) && (V_y(_, u_[0], 28, _v),
                                        V_v = !0),
                                        Vu_ = __V(_, u_[2], _U),
                                        ___(_U[16]))
                                            break;
                                ...
                                if (30 == __U) {
                                    ...
                                    return function(_, ___, v__, V__) {
                                        ...
                                        var u__;
                                        if (10 == ___)
                                            return Vv_(V__, 15) ? (y__ = __V(_, (u__ = V__[15])[0]),
                                            u__ = __v(_, u__[1], 21 == __V(_, u__[2])),
                                            21 == v__ ? --y__[u__] : y__[u__]--) : (u__ = __V(_, V__),
                                            Vv_(V__, 3) && _V_(_, __(V__, 3), u__ - 1),
                                            21 == v__ ? u__ - 1 : u__)
                                    }(_, V_U, yv_, yV_)
                                }
                                            ...
                                            if (34 == __U) {
                                                ...
                                                if (10 == __U)
                                                    ...
                                                    if (15 == __U) {
                                                        ...
                                                        u__ ? (vu_(_V__, _v),
                                                        [y_v, y_v[_v]]) : (_V__.map(function(_) {
                                                            return y_v = y_v[0],
                                                            _
                                                        }).map(function(_) {
                                                            y_v = y_v[_]
                                                    ...
                                                    if (27 == __U) {
                                                        var _y__, _u__ = !1, _U__ = (v___ = u_.slice(0, -1).map(function(__) {
                                                            if (!Vv_(__, 25))
                                                                return __V(_, __);
                                                            _y__ = __V(_, __),
                                                            _u__ = !0
                                                        ...
                                                        __V(_, ___(u_), 0, 0, _U__).apply(void 0, y__(v___))
                                                    }
                                                }
                                            }
                                        }
